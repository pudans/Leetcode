...
fun main() {
    println(Solution442().findDuplicates(intArrayOf(4,3,2,7,8,2,3,1)))
    println(Solution442().findDuplicates(intArrayOf(1,1,2)))
    println(Solution442().findDuplicates(intArrayOf(1)))
}